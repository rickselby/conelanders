...
Route::get('{championship}/results/{event}', 'ResultsController@event')->name('races.results.event');
Route::get('{championship}/results/{event}/{session}/lapchart', 'ResultsController@lapChart')->name('races.results.event.session.lapchart');
Route::get('{championship}/driver-standings', 'StandingsController@drivers')->name('races.standings.drivers');
Route::get('{championship}/constructor-standings', 'StandingsController@constructors')->name('races.standings.constructors');
Route::get('{championship}/team-standings', 'StandingsController@teams')->name('races.standings.teams');
