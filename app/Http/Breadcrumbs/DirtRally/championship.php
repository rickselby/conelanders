...
Breadcrumbs::register('dirt-rally.championship.show', function($breadcrumbs, \App\Models\DirtRally\Championship $championship) {
    $breadcrumbs->parent('dirt-rally.championship.index');
    $breadcrumbs->push($championship->name, route('dirt-rally.championship.show', $championship));
});

Breadcrumbs::register('dirt-rally.championship.edit', function($breadcrumbs, \App\Models\DirtRally\Championship $championship) {
...
Breadcrumbs::register('dirt-rally.championship.season.create', function($breadcrumbs, \App\Models\DirtRally\Championship $championship) {
    $breadcrumbs->parent('dirt-rally.championship.show', $championship);
