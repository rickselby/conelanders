...
abstract class Standings
{
     ...
     * @return []
     */
    protected function dropEvents(RacesChampionship $championship, $results)
    {
     ...
     * @return mixed
     */
    protected function sortAndAddPositions($results, RacesEvent $event = null)
    {
        if ($event) {
     ...
     * @return mixed
     */
    protected function removeEmpty(RacesChampionship $championship, $results)
    {
    ...
    protected function filterResultsPositions($results, RacesEvent $event)
    {
        foreach($results AS $id => $result) {
    ...
    protected function filterPositions($positions, RacesEvent $event)
    {
        $sessionIDs = $event->sessions->where('type', RacesSession::TYPE_RACE)->pluck('id');
        $filteredPositions = [];
