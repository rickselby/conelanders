...
class RacesEvent extends \Eloquent
{
    use Sluggable;
    ...
    {
        return $this->hasMany(RacesSession::class)->orderBy('order');
    }
    ...
    {
        return $query->where('races_championship_id', $model->races_championship_id);
    }    
