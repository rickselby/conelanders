...
@section('content')
    ...
    {!! Form::model($stage, ['route' => ['championship.season.event.stage.update', $stage->event->season->championship->id, $stage->event->season->id, $stage->event->id, $stage->id], 'method' => 'put', 'class' => 'form-horizontal']) !!}
