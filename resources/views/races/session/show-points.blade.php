<div class="panel {{ \RacesSession::hasPoints($session) ? 'panel-success' : 'panel-warning' }}">
    ...
    <div class="panel-collapse collapse" id="points" role="tabpanel">
        <div class="panel-body">
            @if (count($session->entrants))
                {!! Form::open(['route' => ['races.championship.event.session.entrants.points-sequence', $session->event->championship, $session->event, $session], 'class' => 'form-horizontal']) !!}
                ...
                {!! Form::open(['route' => ['races.championship.event.session.entrants.points', $session->event->championship, $session->event, $session], 'class' => 'form-horizontal']) !!}
