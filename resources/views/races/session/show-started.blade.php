...
<div class="panel {{ \RacesSession::hasStartingPositions($session) ? 'panel-success' : 'panel-danger' }}">
    ...
    <div class="panel-collapse collapse {{ \RacesSession::hasStartingPositions($session) ? '' : 'in' }}" id="started" role="tabpanel">
        <div class="panel-body">
            @if (count($session->entrants))

                {!! Form::open(['route' => ['races.championship.event.session.entrants.started-session', $session->event->championship, $session->event, $session], 'class' => 'form-horizontal']) !!}
                ...
                {!! Form::open(['route' => ['races.championship.event.session.entrants.started', $session->event->championship, $session->event, $session], 'class' => 'form-horizontal']) !!}
