...
@section('content')
    ...
    {!! Form::model($team, ['route' => ['races.championship.team.update', $championship, $team], 'method' => 'put', 'class' => 'form-horizontal']) !!}
    ...
    {!! Form::open(['route' => ['races.championship.team.destroy', $championship, $team], 'method' => 'delete', 'class' => 'pull-right']) !!}
