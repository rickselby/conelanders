...
@section('content')
    ...
    {!! Form::model($championship, ['route' => ['races.category.championship.update', $championship->category, $championship], 'method' => 'put', 'class' => 'form-horizontal']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {!! Form::select('constructors_count', \RacesTeamStandings::getOptions(), null, ['class' => 'form-control']) !!}
            <p class="help-block">
    ...
    <div class="form-group">
        {!! Form::label('teams_group_by_size', 'Group Teams championship by team size', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::checkbox('teams_group_by_size', 1) !!}
        </div>
    </div>
