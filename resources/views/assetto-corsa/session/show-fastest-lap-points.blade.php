    ...
    <div class="panel-collapse collapse" id="fastest-lap-points" role="tabpanel">
        <div class="panel-body">
            @if (count($session->entrants))
                ...
                {!! Form::open(['route' => ['assetto-corsa.championship.event.session.entrants.fastest-lap-points', $session->event->championship, $session->event, $session], 'class' => 'form-horizontal']) !!}
